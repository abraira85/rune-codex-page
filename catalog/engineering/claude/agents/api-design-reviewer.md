...
status: experimental
context: "Authored for rune-codex-page's engineering team — not yet run against a real API change. Move to production once it's caught a real breaking change before it shipped."
