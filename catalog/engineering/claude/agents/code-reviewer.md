...
name: code-reviewer
status: experimental
context: "Authored for rune-codex-page's engineering team — not yet run against a real PR. Move to production once it's caught a real bug or bad pattern before merge."
...
20-step checklist that does everything shallowly.
