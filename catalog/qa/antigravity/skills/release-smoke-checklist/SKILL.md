...
status: experimental
context: "Ported from the Claude release-smoke-checklist skill (../../../claude/skills/release-smoke-checklist/SKILL.md) — not yet run against a real release."
...
5. Execute what's executable in this session now. For anything needing
   a subagent not available here, invoke it (`invoke_subagent`) with the
   exact scope rather than skipping silently.
...
development. Ported unchanged in substance from
`../../../claude/skills/release-smoke-checklist/SKILL.md`.
