...
status: experimental
context: "Ported from the Claude bug-report-template skill (../../../claude/skills/bug-report-template/SKILL.md) — not yet run against a real bug backlog."
...
Pairs with the `bug-triage-analyst` subagent in `../../agents/` — that
agent does the reproduction and severity judgment; this skill is the
consistent output format once that judgment is made. Ported unchanged in
substance from `../../../claude/skills/bug-report-template/SKILL.md`.
