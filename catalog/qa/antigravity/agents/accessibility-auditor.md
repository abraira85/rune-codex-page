...
status: experimental
context: "Ported from the Claude accessibility-auditor agent (../../claude/agents/accessibility-auditor.md) — not yet run against a real UI."
...
plain-language review) are out of scope for this role. Ported unchanged
in substance from `../../claude/agents/accessibility-auditor.md`.
