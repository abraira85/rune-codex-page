...
status: experimental
context: "Ported from the Claude exploratory-tester agent (../../claude/agents/exploratory-tester.md) — not yet run against a real charter."
...
tools: [run_command, view_file, write_to_file, list_dir, grep_search]
model: inherit
---
...
minimally confirming, not final triage. Ported unchanged in substance
from `../../claude/agents/exploratory-tester.md`.
