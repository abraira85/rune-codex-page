...
status: experimental
context: "Ported from the Claude mobile-app-tester agent (../../claude/agents/mobile-app-tester.md) — not yet run against a real native app."
...
native platforms rather than browser engines. Ported unchanged in
substance from `../../claude/agents/mobile-app-tester.md`.
