...
status: experimental
context: "Ported from the Claude localization-tester agent (../../claude/agents/localization-tester.md) — not yet run against a real localized UI."
...
about the locale dimension neither of those covers by default. Ported
unchanged in substance from `../../claude/agents/localization-tester.md`.
