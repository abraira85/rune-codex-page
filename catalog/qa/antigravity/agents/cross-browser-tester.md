...
status: experimental
context: "Ported from the Claude cross-browser-tester agent (../../claude/agents/cross-browser-tester.md) — not yet run against a real browser/device matrix."
...
Ported unchanged in substance from `../../claude/agents/cross-browser-tester.md`.
