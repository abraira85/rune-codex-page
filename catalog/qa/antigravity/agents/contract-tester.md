...
status: experimental
context: "Ported from the Claude contract-tester agent (../../claude/agents/contract-tester.md) — not yet run against a real multi-service contract."
...
Ported unchanged in substance from `../../claude/agents/contract-tester.md`.
