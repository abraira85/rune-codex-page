...
status: experimental
context: "Ported from the Claude flaky-test-investigator agent (../../claude/agents/flaky-test-investigator.md) — not yet run against a real intermittent failure."
...
`../mcp/issue-tracker-mcp.md`. Ported unchanged in substance from
`../../claude/agents/flaky-test-investigator.md`.
