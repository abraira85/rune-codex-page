...
status: experimental
context: "Ported from the Claude coverage-analyst agent (../../claude/agents/coverage-analyst.md) — not yet run against a real coverage report."
...
tools: [view_file, run_command, grep_search, list_dir]
model: inherit
---
...
coverage is thin and why it matters, that one writes the test. Ported
unchanged in substance from `../../claude/agents/coverage-analyst.md`.
