...
status: experimental
context: "Authored for rune-codex-page's QA team — not yet run against a real service. Move to production once it's caught a real performance regression."
...
context instead of guessing at future load.
