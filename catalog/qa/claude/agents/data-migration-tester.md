...
status: experimental
context: "Authored for rune-codex-page's QA team — not yet run against a real migration. Move to production once it's caught a real data-loss or corruption bug before it shipped."
