...
status: experimental
context: "Authored for rune-codex-page's QA team — not yet run against a real project's data layer. Move to production once it's set up real, safe test data that other roles actually used."
